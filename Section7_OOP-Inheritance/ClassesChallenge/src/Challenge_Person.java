...
public class Challenge_Person {
    ...
    public String getFullName(){
        ...
        if (this.firstName.isEmpty() &&  this.lastName.isEmpty()){
            return "";
        }else if (this.lastName.isEmpty()){// In case lastName is an empty String, return firstName.
            return this.firstName;
        }else if (this.firstName.isEmpty()) {//In case firstName is an empty String, return lastName.
            return this.lastName;
        }else{
