...
public class Challenge_WallArea {
    // write code here
    // The class needs two fields (instance variables) with name width and height of type double.
    private double width;
    private double height;

    // The class needs to have two constructors: The first constructor does not have any parameters (no-args constructor).
    public Challenge_WallArea(){}
    // The second constructor has parameters width and height of type double and it needs to initialize the fields.
    public Challenge_WallArea(double width, double height){
        setWidth(width);
        setHeight(height);
    }
