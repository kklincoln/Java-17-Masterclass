...
public class Challenge_PaintJobBucketCount {
    ...
    public static int getBucketCount(double width, double height, double areaPerBucket, int extraBuckets){
        ...
        return bucketsToBuy < 0 ? 0 : bucketsToBuy; // Return 0 if no extra buckets are needed, else return the bucketsToBuy
    }

    // second overloaded method:Write another overloaded method named getBucketCount with 3 parameters namely width, height, and areaPerBucket (all of type double).
    public static int getBucketCount(double width, double height, double areaPerBucket) {
        ...
        return totalBucketsNeeded; // Return the total buckets needed
    }

    //third overloaded method: Write another overloaded method named getBucketCount with 2 parameters namely, area and areaPerBucket (both of type double).
