...
public class TaskData {
    ...
    public static Set<Task> getTask(String owner){
        ...
        // is the argument found in the string of possible owners?, if so set user = argument
        String user = (("ann,bob,carol").contains(owner.toLowerCase())) ? owner : null;
        //determine which owner is requested, and then decide which list is appropriate
        ...
        //split each text block by lines
