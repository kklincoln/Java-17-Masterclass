public class Challenge_MultiCar {
    //note that this challenge was completed in the udemy course, all four classes will exist in this one file,
    // but intended to be as separate files
        // write code here
        ...
        public Challenge_MultiCar(int cylinders, String name){
            this.engine = true; //default values
            this.cylinders = cylinders;
            this.name = name;
            this.wheels = 4; //default values
        }
...
/////////////////////////////////////////////////////////////////////////
 class Mitsubishi extends Challenge_MultiCar {
    // write code here
...
class Holden extends Challenge_MultiCar{
    // write code here
...
class Ford extends Challenge_MultiCar {
    // write code here
